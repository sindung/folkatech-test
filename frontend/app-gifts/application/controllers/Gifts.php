...
class Gifts extends CI_Controller {
    ...
    public function index() {
        ...
        $data = array(
            'app_title' => 'List Gifts',
            'app_heading' => 'List Gifts',
            'app_content' => $this->parser->parse('gifts/dashboard', $array, true)
        );
    ...
    public function detail($id = null) {
        ...
        $data = array(
            'app_title' => 'Detail Gifts',
            'app_heading' => 'Detail Gifts',
            'app_content' => $this->parser->parse('gifts/detail', $array, true)
        );
